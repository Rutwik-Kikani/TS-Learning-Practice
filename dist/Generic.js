...
const mergeObj1 = merge({ name: 'zk' }, { age: 20, hobbies: ['Sports', 'Writing'] });
...
//syntax B
const mergeObj3 = genericMerge({ name: 'Pakir', study: '12th' }, { age: 16 });
...
// ...likewise
const objectDataStorage = new DataStorage();
const rObj = { name: 'rk' };
const pObj = { name: 'pk' };
const sObj = { name: 'sk' };
